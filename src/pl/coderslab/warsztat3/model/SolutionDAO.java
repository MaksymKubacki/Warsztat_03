...
public class SolutionDAO {
	public static List<SolutionWithAuthor> loadAllWothAuthor(Connection conn, int count) throws SQLException{
		List<SolutionWithAuthor> result = new ArrayList<>();
		String sql = "SELECT solution.id, solution.title, solution.submition_date, user.name FROM solution JOIN user ON solution.user_id = user.id ORDER BY solution.submition_date DESC LIMIT ?;";
